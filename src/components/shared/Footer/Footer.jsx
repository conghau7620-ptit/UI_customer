            ...
            <footer className="footer">
                <div className="wrapper">
                    <div className="footer-top">
                        ...
                        <div className="footer-top__logo"></div>
                    ...
                    {/* <div className="footer-nav">
                        ...
                        <div className="footer-nav__col">
                            <span className="footer-nav__col-title">
                                Contact
                            </span>
                            <ul>
                                <li>
                                    <i className="icon-map-pin"></i> 27 Division
                                    St, New York, NY 10002, USA
                                </li>
                                <li>
                                    <i className="icon-smartphone"></i>
                                    <div className="footer-nav__col-phones">
                                        <a href="tel:+13459971345">
                                            +1 345 99 71 345
                                        </a>
                                        <a href="tel:+13457464975">
                                            +1 345 74 64 975
                                        </a>
                                    </div>
                                </li>
